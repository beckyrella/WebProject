		                ...
		                <div class="panel panel-default login-form ">
		                  <!-- Default panel contents -->
			                <div class="panel-body ">			                      
			                    ...
			                    <form id='resetpassword' action='<?php echo $membersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
				                    ...
				                    <div class="form-group">
				                      ...
				                      <input type="email" class="form-control input-lg" name="email" id="email" placeholder="emailAddress">
				                    </div>
				                   
				                    <button type="submit" name='Submit' class="btn btn-sec btn-lg btn-block">Reset</button>

...
if(isset($_GET['code']))
{
   ...
   {
        $membersite->RedirectToURL("registrationComplete.php");
   }
}
?>
<!DOCTYPE html>
<html class="login-html">
	<head>
		...
		<title>BusyBodi - Confirm Registration</title>	
				...
				<section class="account">
					...
					<div class="container">
		                ...
		                <div class="panel panel-default login-form ">
			              ...
			              <!--   this page is not visible when link is clicked the verification is auto done and re routed to teh login page	 -->	                      
			                     <h2 class="">Login</h2>
			                    ...
			                    <form id='confirm' action='<?php echo $membersite->GetSelfScript(); ?>' method='get' accept-charset='UTF-8'>
				                    ...
				                    <div class="form-group">
				                      <label class="control-label" for="code">Confirmation Code</label>
				                      <input type="text" class="form-control input-lg" name="code" id="code" placeholder="confirmation code">
				                    </div>
				                   
				                    <button type="submit" name='Submit' class="btn btn-sec btn-lg btn-block">Confirm</button>

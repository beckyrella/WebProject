...
class Membersite
{
    ...
    function UpdateDBRecForConfirmation(&$user_rec)
    {
        ...
        $result = mysqli_query($this->connection, "Select USR_FIRSTNAME, USR_LASTNAME, USR_EMAILADDRESS from $this->tablename where USR_VERIFICATIONCODE='$verificationcode'");   
        if(!$result || mysqli_num_rows($result) <= 0)
        {
